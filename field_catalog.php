...
// Logika filter berdasarkan tipe lapangan dari URL
...
function format_rupiah_catalog($angka){
...
<head>
    ...
    <title>Katalog Lapangan - Pilih Lapangan Olahraga</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow-sm">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <?php if ($is_logged_in && $_SESSION['Level'] == 'user'): ?>
        <div class="btn-group">
      ...
      <?php elseif ($is_logged_in && $_SESSION['Level'] == 'admin'): ?>
        <div class="btn-group">
